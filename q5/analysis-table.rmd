...
print_summary_table(concurrentHash, synchronizedMap, "concurrentHash", "synchronizedMap")
```
...
print_summary_table(copyOnWriteList, synchronizedList, "copyOnWriteList", "synchronizedList")
```
